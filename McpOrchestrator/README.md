...
Building the repo, running the demo, tests, extending, project layout, and debugging live in
**[docs/development.md](https://github.com/Byggarepop/dotnet-mcp-orchestrator/blob/main/docs/development.md)**.
